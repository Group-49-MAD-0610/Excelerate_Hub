...
class ThemeConstants {
  ...
  static const Color onSurfaceVariantColor = Color(0xFF666666);
  static const Color onBackgroundColor = Color(0xFF2C2C2C);

  // Educational Specific Colors
  static const Color courseCardColor = Color(0xFFFAFBFC);
  static const Color programBadgeColor = Color(0xFFE8E4FF);
  static const Color progressBarColor = Color(0xFF00D2D3);
